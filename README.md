...
|   |   |   |
| --- | --- | --- |
| [`kulej ⛰️`](./bluer_sbc/docs/kulej) [![image](../assets2/kulej/20260118_142743.jpg?raw=true)](./bluer_sbc/docs/kulej)  | [`isatis 🔊`](./bluer_sbc/docs/isatis) [![image](../assets2/isatis/01.png?raw=true)](./bluer_sbc/docs/isatis)  | [`swallow head`](./bluer_sbc/docs/swallow-head) [![image](../assets2/swallow/design/head-v2/01.jpg?raw=true)](./bluer_sbc/docs/swallow-head)  |
...
built by 🌀 [`bluer README`](../bluer-objects/bluer_objects/README), based on 🌀 [`bluer_sbc-9.408.1`](https://github.com/kamangir/bluer-sbc).
