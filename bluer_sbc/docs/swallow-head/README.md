...
- [shield design notes](https://github.com/kamangir/bluer-ugv/blob/main/bluer_ugv/docs/swallow/digital/design/shield).
...
1. [nuts, bolts, and spacers](./parts/nuts-bolts-spacers.md): M2: (2 x bolt + 4 x nut + 2 x 5 mm spacer) + M2.5: (4 x bolt + 4 x nut + 8 x 10 mm spacer) + M3: (1 x bolt + 5 x nut + 3 x 35 mm spacer + 3 x 25 mm spacer + 7 x 15 mm spacer + 4 x 5 mm spacer).
